# Dreams Mirror (Maintaied by [Hujanlebattt](https://github.com/hujanlebattt)
...
- Clone this repo:
```
git clone https://github.com/hujanlebattt/DreamsMirror/ && cd DreamsMirror
```
...
1- Install Heroku [windows](https://devcenter.heroku.com/articles/heroku-cli#download-and-install) [Linux](https://devcenter.heroku.com/articles/heroku-cli#other-installation-methods)

2- Install Git On Linux Or [Git Bash](https://git-scm.com/downloads) If Using Windows.

3- Type- heroku login -on Terminal To Login On Heroku.

4- Type- git clone https://github.com/hujanlebattt/DreamsMirror -on Terminal.
