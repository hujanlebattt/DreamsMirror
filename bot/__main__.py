...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://github.com/fransjsph/DreamsMirror")
    buttons.buildbutton("Owner", "https://t.me/hujanlebattt")
...
'''
        ...
        sendMarkup('Not Authorized user, Please Contact Owner', context.bot, update, reply_markup)
...
help = telegraph.create_page(
        title='Dreams Mirror Drive Help',
...
/{BotCommands.RestartCommand}: Restart and update the bot (Only Owner)
